define(["exports"], (function(t) {
    ...
    class a {
        ...
        handleRequest({request: t, event: e}) {
            ...
            let a = i && i.handler;
            const o = t.method;
            if (!a && this.i.has(o) && (a = this.i.get(o)),
            !a)
                return;
            let c;
            try {
    ...
    function T(t) {
        return t !== IDBDatabase.prototype.transaction || "objectStoreNames"in IDBTransaction.prototype ? (x || (x = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(t) ? function(...e) {
            return t.apply(P(this), e),
            B(L.get(this))
        }
        : function(...e) {
        ...
        : function(e, ...s) {
            ...
            return C.set(n, e.sort ? e.sort() : [e]),
            B(n)
        }
    }
    function k(t) {
        return "function" == typeof t ? T(t) : (t instanceof IDBTransaction && function(t) {
            if (I.has(t))
                return;
    ...
    function S(t, e) {
        ...
        const s = e.replace(/FromIndex$/, "")
          , n = e !== s
          , r = W.includes(s);
        if (!(s in (n ? IDBIndex : IDBObjectStore).prototype) || !r && !M.includes(s))
            return;
    ...
    class F {
        ...
        async getDb() {
            return this.U || (this.U = await function(t, e, {blocked: s, upgrade: n, blocking: r, terminated: i}={}) {
    ...
    class H {
        ...
        async expireEntries() {
            ...
            for (const t of e)
                await s.delete(t, this.B);
            this.N = !1,
            this.O && (this.O = !1,
            b(this.expireEntries()))
        }
        ...
        async delete() {
            this.O = !1,
            await this.P.expireEntries(1 / 0)
        }
    }
    try {
        ...
        try {
            ...
            const r = function(t) {
              ...
              , a = function(t, e, n) {
                ...
                let i, a;
                return void 0 !== e && void 0 !== n ? (i = e,
                a = n + 1) : void 0 !== e && void 0 === n ? (i = e,
                a = r) : void 0 !== n && void 0 === e && (i = r - n,
                a = r),
                {
                    start: i,
                    end: a
            ...
            return h.headers.set("Content-Length", String(c)),
    ...
    class Z extends v {
        ...
        K() {
            ...
            for (const [s,n] of this.plugins.entries())
                n !== Z.copyRedirectedCacheableResponsesPlugin && (n === Z.defaultPrecacheCacheabilityPlugin && (t = s),
                n.cacheWillUpdate && e++);
    ...
    class tt {
        ...
        precache(t) {
            ...
            this.$ || (self.addEventListener("install", this.install),
    ...
    t.RangeRequestsPlugin = class {
        constructor() {
            this.cachedResponseWillBeUsed = async ({request: t, cachedResponse: e}) => e && t.headers.has("range") ? await $(t, e) : e
        }
    }
    ,
